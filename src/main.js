...
function renderNav() {
  const groups = [
    ...
    { title: '实战 · 追问', ids: ['probe'] },
    { title: '大厂 · 真题', ids: ['real'] },
    { title: '工程 · 基础', ids: ['wf'] },
...
function chapterView(c) {
  ...
  if (c.cards) {
    ...
    else if (c.id === 'probe') { cardTitle = 'Agent 追问链 8 题'; cardHint = '点右上角「揭」看四层追问 + 面试官考察意图，这是大厂真正的分水岭'; }
    else if (c.id === 'real') { cardTitle = '大厂 Agent 真实面经 9 题'; cardHint = '腾讯/字节/快手二面高频真题，点「揭」看答案 + 追问意图'; }
